...
namespace MangoStore_API.Migrations
{
    ...
    [Migration("20240519103446_addOrderHeaderAndOrderDetails")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MangoStore_API.Models.CartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MangoStore_API.Models.MenuItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MangoStore_API.Models.OrderDetails", b =>
                {
            ...
            modelBuilder.Entity("MangoStore_API.Models.OrderHeader", b =>
                {
                    b.Property<int>("OrderHeaderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MangoStore_API.Models.ShoppingCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MangoStore_API.Models.User", b =>
                {
            ...
            modelBuilder.Entity("MangoStore_API.Models.CartItem", b =>
                {
                    b.HasOne("MangoStore_API.Models.MenuItem", "MenuItem")
                        .WithMany()
                        .HasForeignKey("MenuItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MangoStore_API.Models.ShoppingCart", null)
                        .WithMany("CartItems")
            ...
            modelBuilder.Entity("MangoStore_API.Models.OrderDetails", b =>
                {
                    ...
                    b.HasOne("MangoStore_API.Models.OrderHeader", null)
            ...
            modelBuilder.Entity("MangoStore_API.Models.OrderHeader", b =>
                {
                    b.HasOne("MangoStore_API.Models.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MangoStore_API.Models.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
